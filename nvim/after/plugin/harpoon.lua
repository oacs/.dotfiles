...
-- Terminal commands
map("n", "<leader>th", ':lua require("harpoon.term").gotoTerminal(1)<CR>')
map("n", "<leader>tt", ':lua require("harpoon.term").gotoTerminal(2)<CR>')
...
map("n", "<leader>ts", ':lua require("harpoon.term").sendCommand(1, 1)<CR>')
